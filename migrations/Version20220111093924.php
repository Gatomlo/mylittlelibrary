 ...
 */
final class Version20220111093924 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, isbn INT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, code VARCHAR(255) NOT NULL, owner VARCHAR(255) NOT NULL, shelf VARCHAR(255) DEFAULT NULL, abstract LONGTEXT DEFAULT NULL, paging INT DEFAULT NULL, editor VARCHAR(255) DEFAULT NULL, price DOUBLE PRECISION DEFAULT NULL, language VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rental_book DROP FOREIGN KEY FK_44A9FCF116A2B381');
